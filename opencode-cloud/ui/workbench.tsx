...
type Identity = { role?: 'admin'|'engineer'; auth_provider?: 'local-admin'|'local-engineer'|'netid'; user_id: string; display_name: string; project: string; directory: string; ready: boolean }
